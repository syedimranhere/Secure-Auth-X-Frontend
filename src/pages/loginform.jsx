...
export default function Login() {
    ...
    // this will trigger on refreshing the page
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            if (now > unlockTime) {
                console.log("🟢 Time expired, enabling login...");
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (status === 429) {
                console.log("Setting true normal ")
                ...
                setTimeout(() => {
                    console.log("Setting false normal ")
                    localStorage.removeItem("blockedInfo");
                ...
                setError(error?.response?.data?.message || "Login failed | Recheck ID and Pass ");
                        ...
                        >
                            ...
                            <button
                                ...
                                className={`w-full py-2 font-semibold rounded-md transition-all ${disableLogin
                                    ? "bg-[#00FFD1]/30 text-black cursor-not-allowed" // No animation, no hover
                                    : loading
